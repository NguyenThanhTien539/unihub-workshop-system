import { Share2, Bookmark, Info, CheckCircle2 } from "lucide-react"
    ...
    <div className="flex flex-col gap-5">
      ...
      <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          Khám phá những kiến thức cơ bản về AI và học máy. Tìm hiểu về các thuật toán phổ biến, ứng dụng thực tế và xu hướng công nghệ mới nhất trong lĩnh vực AI.
        </p>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>• Kỹ năng thực hành qua tình huống thực tế</li>
              <li>• Kinh nghiệm từ chuyên gia hàng đầu</li>
              <li>• Kết nối với các bạn cùng sở thích</li>
            </ul>
          </div>
          <div>
            <h3 className="flex items-center gap-2 font-bold mb-4">
      ...
      <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="space-y-8 relative before:absolute before:left-[1.1rem] before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-100">
          {[
            { step: 1, title: 'Giới thiệu và khởi động', time: '30 phút', desc: 'Làm quen với diễn giả và các thành viên khác' },
            { step: 2, title: 'Phần lý thuyết chính', time: '60 phút', desc: 'Trình bày kiến thức nền tảng và tình huống thực tế' },
            { step: 3, title: 'Nghỉ giải lao', time: '15 phút', desc: '' },
            { step: 4, title: 'Hỏi đáp và kết thúc', time: '35 phút', desc: 'Giải đáp thắc mắc và kết nối' },
          ].map((item) => (
